...
Public Class report_rcf_rga
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CPRI_CAPSTONE_PROJECT.report_rcf_rga.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_rcf_rga
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_rcf_rga = New report_rcf_rga()
        rpt.Site = Me.Site
        Return rpt
    End Function
