...
Public Class report_book_list
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CPRI_CAPSTONE_PROJECT.report_book_list.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_book_list
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_book_list = New report_book_list()
        rpt.Site = Me.Site
        Return rpt
    End Function
